...
Private Sub GitHubLink As Tag
	...
	Dim anchor1 As Tag = Anchor.href("https://github.com/pyhoon/pakai-server-b4j/tree/v6.00").cls("text-primary mr-1").up(div1)
	...
	Dim anchor2 As Tag = Anchor.href("https://github.com/pyhoon/pakai-server-b4j/tree/v6.00").sty("text-decoration: none").targetOf("_blank").up(div1)
